<!DOCTYPE html>
<!-- saved from url=(0066)http://jenkinsapp-env.eba-ptvd3vfm.us-east-2.elasticbeanstalk.com/ -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>PHP Application - AWS Elastic Beanstalk</title>
    <meta name="viewport" content="width=device-width">
    <link rel="stylesheet" href="./PHP Application - AWS Elastic Beanstalk_files/css" type="text/css">
    <link rel="icon" href="https://awsmedia.s3.amazonaws.com/favicon.ico" type="image/ico">
    <link rel="shortcut icon" href="https://awsmedia.s3.amazonaws.com/favicon.ico" type="image/ico">
    <!--[if IE]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
    <link rel="stylesheet" href="./PHP Application - AWS Elastic Beanstalk_files/styles.css" type="text/css">
</head>
<body>
    <section class="congratulations">
        ...
        <p>You are running PHP version 8.0.13</p>
    ...
    <section class="instructions">
        ...
        <ul>
            ...
            </li><li><a href="http://docs.amazonwebservices.com/elasticbeanstalk/latest/dg/customize-containers-ec2.html">Customizing the Software on EC2 Instances</a></li>
